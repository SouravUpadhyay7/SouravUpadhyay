            ...
            >
              ...
              <div className="absolute inset-0 rounded-xl overflow-hidden pointer-events-none">
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(90deg, transparent 0%, rgba(244, 63, 94, 0.9) 50%, transparent 100%)',
                ...
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(270deg, transparent 0%, rgba(244, 63, 94, 0.9) 50%, transparent 100%)',
                    backgroundSize: '40% 100%',
                    boxShadow: '0 0 10px rgba(244, 63, 94, 0.8)',
                  }}
                  animate={{
                ...
                <motion.div
                  ...
                  style={{
                    background: 'linear-gradient(0deg, transparent 0%, rgba(168, 85, 247, 0.9) 50%, transparent 100%)',
                    backgroundSize: '100% 40%',
                    boxShadow: '0 0 10px rgba(168, 85, 247, 0.8)',
                  }}
                  animate={{
